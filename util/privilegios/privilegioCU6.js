...
exports.ver_lead = (request, response, next) => {
    
    // Inicializa la variable de privilegio
    let puedeConsultarLead = false;
    ...
    if (Privilegios.some(Privilegios => Privilegios.Descripcion === 'Consulta lead.')) {
        puedeConsultarLead = true;
    }
